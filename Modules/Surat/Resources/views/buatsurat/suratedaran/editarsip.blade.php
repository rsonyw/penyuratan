                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Edit Arsip Surat Edaran
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row match-height">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ url('surat/suratedaran', $suratedaran->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-12 position-relative">
                                            <div class="mb-2">
                                                <label class="form-label" for="tgl_suratedaran">Tanggal Surat</label>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <textarea name="keterangan" id="keterangan" class="form-control" placeholder="Keterangan...">{{ $suratedaran->keterangan }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
