            ...
            <div class="content-header row">
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Data Surat Tugas Keluar Kantor</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Surat Tugas Keluar Kantor
                                    </li>
                                </ol>
                            </div>
                        </div>
                                        ...
                                        @if (!empty($surattgskks))
                                            @foreach ($surattgskks as $surattgskk)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>{{ $surattgskk->no_surattgskk }}</center>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <center>{{ $surattgskk->tertanda }}</center>
                                                    </td>
                                                    <td>
