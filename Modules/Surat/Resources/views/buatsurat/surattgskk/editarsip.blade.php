                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Edit Surat Tugas Keluar Kantor
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row match-height">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ url('surat/surattgskk', $surattgskk->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-12 position-relative">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="tgl_surattgskk"
                                                    class="form-control flatpickr-basic" placeholder="18 June, 2020"
                                                    name="tgl_surattgskk" value="{{ $surattgskk->tgl_surattgskk }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="no_surattgskk" class="form-control"
                                                    placeholder="085/B/SWB/V/2022" name="no_surattgskk"
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="instansi" class="form-control"
                                                    ...
                                                    value="{{ $surattgskk->instansi }}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
                                                <label class="form-label" for="keterangan">Keterangan</label>
                                                <textarea name="keterangan" id="keterangan" class="form-control" placeholder="Keterangan...">{{ $surattgskk->keterangan }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
