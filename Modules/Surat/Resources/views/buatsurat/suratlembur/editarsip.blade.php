                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Edit Surat Perintah Lembur
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            <div class="card-header">
                                <h4 class="card-title">Surat Perintah Lembur</h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="{{ url('surat/suratlembur', $suratlembur->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-12 position-relative">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="tgl_suratlembur"
                                                    class="form-control flatpickr-basic" placeholder="18 June, 2020"
                                                    name="tgl_suratlembur" value="{{ $suratlembur->tgl_suratlembur }}" />
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <div class="mb-2">
                                                <label class="form-label" for="no_suratlembur">Nomor Surat</label>
                                                <input type="text" id="no_suratlembur" class="form-control"
                                                    placeholder="085/B/SWB/V/2022" name="no_suratlembur"
                                                    value="{{ $suratlembur->no_suratlembur }}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="instansi" class="form-control"
                                                    placeholder="Nama PT" name="instansi"
                                                    value="{{ $suratlembur->instansi }}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
                                                <label class="form-label" for="keterangan">Keterangan</label>
                                                <textarea name="keterangan" id="keterangan" class="form-control" placeholder="Keterangan...">{{ $suratlembur->keterangan }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
