                                    ...
                                    <div class="row">
                                        <div class="col-12 position-relative">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="tgl_suratperdin"
                                                    class="form-control flatpickr-basic" placeholder="18 June, 2020"
                                                    name="tgl_suratperdin" value="{{ $suratperdin->tgl_suratperdin }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="no_suratperdin" class="form-control"
                                                    placeholder="085/B/SWB/V/2022" name="no_suratperdin"
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="instansi" class="form-control"
                                                    ...
                                                    value="{{ $suratperdin->instansi }}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
                                                <label class="form-label" for="keterangan">Keterangan</label>
                                                <textarea name="keterangan" id="keterangan" class="form-control" placeholder="Keterangan...">{{ $suratperdin->keterangan }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
