                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Edit Surat Masuk
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row match-height">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ url('surat/suratmasuk', $suratmasuk->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-12 position-relative">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="no_suratmasuk" class="form-control"
                                                    name="no_suratmasuk" value="{{ $suratmasuk->no_suratmasuk }}" />
                                            </div>
                                        </div>
                                        <div class="col-12 position-relative">
                                            <div class="mb-2">
                                                <label class="form-label" for="tgl_suratmasuk">Tanggal Surat</label>
                                                <input type="text" id="tgl_suratmasuk"
                                                    class="form-control flatpickr-basic" name="tgl_suratmasuk"
                                                    value="{{ $suratmasuk->tgl_suratmasuk }}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
