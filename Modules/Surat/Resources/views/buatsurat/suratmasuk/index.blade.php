            ...
            <div class="content-header row">
                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Data Surat Masuk</h2>
                    ...
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                data-bs-target="#editUser">Tambah Surat</button>
                        </div>
                    </div>
                </div>
                                        ...
                                        @if (!empty($suratmasuks))
                                            @foreach ($suratmasuks as $suratmasuk)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>{{ $suratmasuk->no_suratmasuk }}</center>
                                                    </td>
                                                    <td>
                                                        <center>{{ $suratmasuk->tgl_suratmasuk }}</center>
                                                    </td>
                                                    <td>
                                                        <center>{{ $suratmasuk->perihal }}</center>
                                                    </td>
                                                    <td>
                                                        <center>{{ $suratmasuk->instansi }}</center>
                                                    </td>
                                                    <td>
                                                        <center>{{ $suratmasuk->keterangan }}</center>
                                                    </td>
                                                    <td>
                                                        <center>
