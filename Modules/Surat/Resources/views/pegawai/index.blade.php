            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            <a href="/surat/datapegawai/create" type="button" class="btn btn-success">Tambah Data
                                Pegawai</a>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="datatables-basic table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <center>Tanggal Masuk Karyawan</center>
                                            </th>
                                            <th>
                                                <center>Tanggal Pengangkatan Karyawan Tetap</center>
                                            </th>
                                            <th>
                                                <center>NIP</center>
                                            </th>
                                            ...
                                            <th>
                                                <center>Uang Saku</center>
                                            </th>
                                            <th>
                                                <center>Uang Representatif</center>
                                            </th>
                                            <th>
                                        ...
                                        @if (!empty($datapegawais))
                                            @foreach ($datapegawais as $datapegawai)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>{{ $datapegawai->nama }}</center>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <center>{{ $datapegawai->tanggal_masuk }}</center>
                                                    </td>
                                                    <td>
                                                        <center>{{ $datapegawai->tanggal_penetapan }}</center>
                                                    </td>
                                                    <td>
                                                        <center>{{ $datapegawai->nip }}</center>
                                                    </td>
                                                    <td>
                                                        <center>{{ $datapegawai->jabatan }}</center>
                                                    </td>
                                                    <th>
                                                        <center>{{ $datapegawai->no_hp }}</center>
                                                    </th>
                                                    <th>
                                                        <center>{{ $datapegawai->no_rek }}</center>
                                                    </th>
                                                    <td>
                                                        <center>{{ $datapegawai->saku }}</center>
                                                    </td>
                                                    <td>
                                                        <center>{{ $datapegawai->representatif }}</center>
                                                    </td>
                                                    <td>
                                                        <center>
                                                            <a href="{{ url('surat/datapegawai/' . $datapegawai->id . '/edit') }}"
                                                                class="btn btn-icon btn-warning">Edit</a>
                                                            <form
                                                                action="{{ url('surat/datapegawai', $datapegawai->id) }}"
                                            ...
                                            @endforeach
                                        @endif
                                        {{-- @if (!empty($suratmasuks))
                                            @foreach ($suratmasuks as $suratmasuk)
                                                <tr>
                                                    <td>
                                                        <center>
                                                            @if ($suratmasuk->dokumen)
                                                                <a href="{{ asset('storage/' . $suratmasuk->dokumen) }}"
                                                                    target="blank" class="btn btn-icon btn-success"><span
                                                                        data-feather="eye"></span></a>
                                                                <a href="{{ url('surat/suratmasuk/' . $suratmasuk->id . '/edit') }}"
                                                                    class="btn btn-icon btn-warning"><span
                                                                        data-feather="edit"></span></a>
                                                                <form
                                                                    action="{{ url('surat/suratmasuk', $suratmasuk->id) }}"
                                                                    method="post" class="d-inline">
                                                                    @method('delete')
                                                                    @csrf
                                                                    <button class="btn btn-icon btn-danger border-0"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    <div class="text-center mb-2">
                        <h1 class="mb-1">Detail Pegawai</h1>
                    </div>
                    <form id="editUserForm" class="row gy-1 pt-75" method="GET" action="/surat/datapegawai"
