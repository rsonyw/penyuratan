                ...
                <div class="row match-height">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ url('surat/datapegawai', $datapegawai->id) }}"
                                    class="form">
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <textarea type="text" id="alamat" class="form-control" placeholder="Masukkan Alamat" name="alamat"
                                                    value="">{{ $datapegawai->alamat }} </textarea>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-2">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-2">
                                                ...
                                                <select id="pendidikan" name="pendidikan" class="form-select"
                                                    aria-label="Default select example">
                                                    <option selected>{{ $datapegawai->pendidikan }}</option>
                                        ...
                                        <div class="col-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="tanggal_penetapan"
                                                    ...
                                                    value="{{ $datapegawai->tanggal_penetapan }}" />
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-2">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="representatif" class="form-control"
                                                    ...
                                                    value="{{ $datapegawai->representatif }}" />
                                            </div>
                                        </div>
